                ...
                <div class="auto-container">
                    <div class="content-box">
                        <div class="content">
                            <div class="clearfix">
                                <div class="inner">
                                    <div class="bg-image"><img src="images/main-slider/banner-bg-text.svg" alt=""
                                            title=""></div>
                                    <h2>Never Stop</h2>
                                    <h1><span>Exploring</span></h1>
                                    <div class="text">Keep the excitement flowing! Grow with every opportunity to
                                        explore new things, ideas and experiences. Richness in life gives it depth and
                                        meaning.
                                    </div>
                                    <div class="links-box clearfix">
                                        <div class="link"><a href="#" class="theme-btn btn-style-one"><span>View All
                                                    Tours<i class="icon"><img src="images/icons/logo-icon.svg" alt=""
                                                            title=""></i></span></a></div>
                                    </div>
                                </div>
        ...
        <div class="row clearfix">
            ...
            <div class="text-col col-lg-6 col-md-12 col-sm-12">
                <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                    <div class="title-box">
                        <div class="subtitle">About Basecamp Baazar</div>
                        <!-- <h2><span>World Best Travel </span></h2> -->
                        <div class="text">Welcome to Basecamp Bazaar, where adventure meets quality gear!
                            At Basecamp Bazaar, we're passionate about exploring the great outdoors and
                            equipping fellow
                            adventurers with the tools they need to make every journey unforgettable. Whether
                            you're
                            embarking on a challenging trek through rugged terrain or setting up camp under the
                            stars,
                            we've got you covered with a wide range of top-notch camping and trekking equipment.
                            <a href="#">More...</a>
                        </div>
                    </div>
                    <div class="lower-box">
        ...
        <div class="row clearfix">
            <div class="left-col col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner">
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box">
                                <object type="image/svg+xml" data="images/resource/icon-1.svg" class="svg-img">
                                </object>
                            </div>
                            <h4>Diverse Destinations</h4>
                            <div class="text">Wanderlust" perfectly captures that insatiable desire to explore
                                and
                                travel. </div>
                        </div>
                    </div>
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="images/resource/icon-2.svg" class="svg-img" alt="">
                            </div>
                            <h4>Value for Money</h4>
                            <div class="text">Everything good doesn't have to cost a fortune. It can also be
                                affordable.
                            </div>
                        </div>
                    </div>
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="images/resource/icon-3.svg" class="svg-img" alt="">
                            </div>
                            <h4>Beautiful Places</h4>
                            <div class="text">Explore the Earth's beauty at its best. Our experience can help
                                you plan
                                better.</div>
                        </div>
                    </div>
            ...
            <div class="right-col col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="inner">
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="images/resource/icon-4.svg" class="svg-img" alt="">
                            </div>
                            <h4>Fast Booking</h4>
                            <div class="text">We are just a click away. Get in touch and experience the ease of
                                planning
                                a perfect travel </div>
                        </div>
                    </div>
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="images/resource/icon-5.svg" class="svg-img" alt="">
                            </div>
                            <h4>Support Team</h4>
                            <div class="text">Our team is always eager to help you in any way. Customer
                                satisfaction is
                                our prime goal.
                            </div>
                        </div>
                    ...
                    <div class="why-block">
                        <div class="inner-box">
                            <div class="icon-box"><img src="images/resource/icon-6.svg" class="svg-img" alt="">
                            </div>
                            <h4>Passionate Travel</h4>
                            <div class="text">Our passion for travel keeps us going and doing wonders for
                                everyone
                                around us.</div>
                        </div>
                    </div>
