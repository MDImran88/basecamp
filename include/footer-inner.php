                ...
                <div class="row clearfix">
                    ...
                    <div class="footer-column col-xl-4 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="footer-logo">
                            <div class="logo"><a href="index.html" title="Basecamp Baazar"><img src="images/logo.png" alt="" title="Basecamp Baazar"></a></div>
                        </div>
                        <div class="footer-text">
                        Welcome to Basecamp Bazaar, where adventure meets quality gear! </br>
                        At Basecamp Bazaar, we're passionate about exploring the great outdoors and equipping fellow adventurers with the tools they need to make every journey unforgettable.
